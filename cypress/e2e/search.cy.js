    ...
    describe('Search results', () => {
        it('Displays basic case information', () => {
            ...
            cy.contains('.sirius-search__item', 'Giusto Rita, Donor').within(() => {
                cy.contains('a', '7000-2910-9383').should('have.attr', 'href', '/#/person/75/14');
        ...
        it('Expands cases', () => {
            ...
            cy.get('.sirius-search__item:contains(Lloyd Poullard, Donor)')
                .eq(0)
                .within(() => {
                    cy.contains('a', '7000-2910-2948').should('have.attr', 'href', '/#/person/94/315');
            ...
            cy.get('.sirius-search__item:contains(Lloyd Poullard, Donor)')
                .eq(1)
                .within(() => {
                    cy.contains('a', '7000-2910-1244').should('have.attr', 'href', '/#/person/94/219');
                    cy.contains('dt', 'Status').next().contains('Pending');
